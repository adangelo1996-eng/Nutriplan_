...
var TUTORIAL_STEPS_BY_PAGE = {
  'casa': [
    ...
    { icon: '📱', title: 'Scena 3D (se attiva)', text: 'Se vedi la cucina 3D, puoi ruotare la vista trascinando con il dito o il mouse. La scena è ottimizzata per mobile.', page: 'casa', target: '#casaContent', hint: 'L\'etichetta sul tavolo ha lo stesso contenuto della card.' },
    { icon: '🌅', title: 'Illuminazione dinamica', text: 'L\'illuminazione della scena 3D cambia in base all\'ora (CET): alba, giorno, sera, notte. Di notte prevale la luce interna.', page: 'casa', target: '#casaContent', hint: 'Usa l\'ora di sistema per vedere l\'effetto.' },
    { icon: '👆', title: 'Hover sull\'etichetta', text: 'Se sei sulla scena 3D, passando con il mouse sull\'etichetta sul tavolo compare il popup "Vai Oggi". Clicca per andare a Oggi.', page: 'casa', target: '#casaContent', hint: 'Su touch puoi toccare direttamente l\'etichetta.' },
